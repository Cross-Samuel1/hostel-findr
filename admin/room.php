						...
						<form name="form" method="post">
                            <div class="form-group">
                                            ...
                                            <select name="troom"  class="form-control" required>
                                                ...
                                                <option value="High End Room">High End</option>
                                                <option value="Standard Room">Standard</option>
												<option value="Custom Room">Custom</option>
												<option value="Budget Room">Budget</option>
                                            </select>
                              </div>
                               ...
                               <!--<div class="form-group">
                                            ...
                                            <select name="bed" class="form-control" required>
												<option value selected ></option>
                                                <option value="Queen's Court">Queen's Court</option>
                                                <option value="Old Girl's Hostel">Old Girl's Hostel</option>
												<option value="Mawuena">Mawuena</option>
                                                <option value="Naa Morkor">Naa Morkor</option>
                                                <option value="Starleys">Starleys</option>
                                                <option value="ICGC Boys Hostel">ICGC Boys Hostel</option>
                                                <option value="Joy 4 Fame">Joy 4 Fame</option>
